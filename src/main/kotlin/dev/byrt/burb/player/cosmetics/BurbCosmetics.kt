...
enum class BurbCosmetic(val cosmeticName: String, val cosmeticId: String, val cosmeticLore: List<Component>, val cosmeticObtainment: List<Component>, val cosmeticType: ItemType, val cosmeticModel: String, val cosmeticRarity: ItemRarity) {
    ...
    HAT_PLUSH_MASKY("Plushie (Masky)", "burb.cosmetic.hat.plushie_alyssa", listOf(Formatting.allTags.deserialize("<i><gray>Help! I'm a marketable plushie.")), listOf(Formatting.allTags.deserialize("<!i><burbcolour>Obtained from the sticker shop.")), ItemType.HAT, "masky", ItemRarity.UNCOMMON),
    // Rare
    HAT_EMOJI_EXPLODE("Emoji (Explode)", "burb.cosmetic.hat.emoji_explode", listOf(Formatting.allTags.deserialize("<i><gray>MIND. BLOWN.")), listOf(Formatting.allTags.deserialize("<!i><#ffff00>Obtained by winning football.")), ItemType.HAT, "explode_emoji", ItemRarity.RARE),
    HAT_EMOJI_FLUSHED("Emoji (Flushed)", "burb.cosmetic.hat.emoji_flushed", listOf(Formatting.allTags.deserialize("<i><gray>:point_right: :point_left:")), listOf(Formatting.allTags.deserialize("<!i><#ffff00>Obtained by winning football.")), ItemType.HAT, "flooshed_emoji", ItemRarity.RARE),
    HAT_EMOJI_NERD("Emoji (Nerd)", "burb.cosmetic.hat.emoji_nerd", listOf(Formatting.allTags.deserialize("<i><gray>Erm, actually...")), listOf(Formatting.allTags.deserialize("<!i><#ffff00>Obtained by winning football.")), ItemType.HAT, "nerd_emoji", ItemRarity.RARE),
    // Epic
    ...
    // Legendary
    HAT_PENNY_RV("Penny", "burb.cosmetic.hat.penny_rv", listOf(Formatting.allTags.deserialize("<i><gray>Crazy Dave's best friend.")), listOf(Formatting.allTags.deserialize("<!i><light_purple>Obtained from <obf>■■■■■■■■</obf>.")), ItemType.HAT, "penny_rv", ItemRarity.LEGENDARY),
}